...
class ExpiringModule:
    def __init__(self, module, run_code=""):
        ...
        Args:
            ...
            run_code: Any code to be evaluated while importing,
                note that if you wish to refer to the module you are
        ...
        Note:
            It is not safe to use while threading if other modules are
            imported and/or globals set while performing the `with` statement.
        """
        self._module = module
    ...
    def __enter__(self):
        self.__variables = [v for v in globals().keys()]
        ...
        self.__variables = [
            v for v in globals().keys() if v not in self.__variables
        ]
