...
from scanomatic.io.source import get_source_information, parse_version
    ...
    def redirect_to_pm():
        if rpc_client.online:
            ...
            if 'host' in val and val['host']:
                ...
                return json_abort(
                    400,
                    reason="Power Manager not know/found by Scan-o-Matic. Check your settings.",  # noqa: E501
                )
        else:
            return json_abort(400, reason="Server offline")
