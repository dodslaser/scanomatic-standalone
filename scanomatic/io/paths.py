...
class Paths(SingeltonOneInit):
    def __one_init__(self, *args):
        ...
        self.root = os.path.abspath(os.environ.get("SCANOMATIC_DATA", os.path.join(os.path.expanduser("~"), ".scan-o-matic")))
        self.package_root = os.path.abspath(os.path.dirname(scanomatic.__file__))
        ...
        self.images = os.path.join(self.package_root, "data/images")
        ...
        self.ui_root = os.path.join(self.package_root, "frontend")
        self.ui_css = os.path.join(self.package_root,  "data/css")
        self.ui_js = os.path.join(self.package_root, "data/js")
        self.ui_html = os.path.join(self.package_root, "data/html")
        self.ui_templates = os.path.join(self.package_root, "data/html/templates")
        ...
        self.ui_root_template = 'root.html'
        ...
        self.fixture_conf_file_rel_pattern = "{0}" + self.fixture_conf_file_suffix
        self.fixture_image_file_rel_pattern = "{0}.npy"
        self.fixture_conf_file_pattern = os.path.join(self.fixtures, self.fixture_conf_file_rel_pattern)
        self.fixture_image_file_pattern = os.path.join(self.fixtures, self.fixture_image_file_rel_pattern)
        self.fixture_tmp_scan_image = self.fixture_image_file_pattern.format(".tmp")
        ...
        self.ccc_image_plate_transformed_slice_pattern = os.path.join(self.ccc_folder, "{0}.{1}.plate_{2}.transformed.npy")
        ...
        self.experiment_local_fixturename = self.fixture_conf_file_rel_pattern.format("fixture")
        ...
        self.phenotypes_extraction_params_legacy = "phenotype_params.npy"
